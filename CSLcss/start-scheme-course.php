    ...
    <body>
        ...
        <section class="container about py-5">
            <div class="about-CSLls-info">
                <p class="sub-tittle">
                <div class="tab">
                    <button class="tablinks" id="defaultOpen" onclick="openCourse(event, 'Overview')">Start Scheme</button>
                ...
                <div id="Overview" class="tabcontent ">
                    <h3>Overview</h3>
                    <span>
                        Standard Training Assessment and Reward (STAR) Scheme aimed at skilling and certifying youth across several
                        job roles as per the National Occupational Standards (NOS) defined by different Sector Skill Councils.
