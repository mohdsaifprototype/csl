    ...
    <body>
        ...
        <section class="container about py-5">
            <div class="about-CSLls-info">
                <p class="sub-tittle">
                <div class="tab">
                    <button class="tablinks" id="defaultOpen" onclick="openCourse(event, 'Overview')">ACCOUNT EXECUTIVE</button>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <ul>
                                    ...
                                    <hr style="width: 100%;">
                                    <li>Module - 2 : Tally ERP 9 with GST</li>
                                    <hr style="width: 100%;">
                                    <li>Module - 3 : Advance Excel MIS</li>
                                    <hr style="width: 100%;">
                                    <li>Module - 4 : Professional Skills Training</li>
                                    <hr style="width: 100%;">
