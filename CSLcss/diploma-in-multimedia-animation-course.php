    ...
    <body>
        ...
        <section class="container about py-5">
            ...
            <div class="about-CSLls-info">
                <p class="sub-tittle">
                <div class="tab">
                    <button class="tablinks" id="defaultOpen" onclick="openCourse(event, 'Overview')">Multimedia & Animation</button>
                ...
                <div id="Overview" class="tabcontent ">
                    <h3>Overview</h3>
                    <p style="color:black;font-size: 16px;font-weight: bold;margin-top: 15px;margin-bottom: 5px;">Multimedia & Animation</p>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <ul>
                                    ...
                                    <hr style="width: 100%;">
                                    <li>Module - 5 : AUTODESK 3DS MAX</li>
                                    <hr style="width: 100%;">
                                    <li>Module - 6 : PROJECT WORK</li>
                                    <hr style="width: 100%;">
